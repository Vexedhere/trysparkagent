  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/[0.06] bg-base/70 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-[1280px] items-center justify-between px-6 lg:px-8">
        ...
        <div className="hidden md:block"><a href="#auth" className="rounded-full bg-spark-gradient px-5 py-2 font-body text-[14.5px] font-medium text-white shadow-[0_1px_0_0_rgba(255,255,255,0.2)_inset] transition-transform hover:scale-[1.03]">Get started</a></div>
